...
const SidebarItems = [
  {
    title: "title1",
    svg: <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const Sidebar: React.FC<SidebarProps> = () => {
  return (
    <div className="flex flex-col items-center w-56 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
